  ...
  return (
    ...
    <div className="w-full items-center justify-center flex flex-row flex-wrap gap-10 mt-24">
      ...
      <div className="w-[25rem] relative  group">
        ...
        <Link href="/burner">
            <button className="text-3xl w-full font-bold bg-black h-[15rem]">Burner</button>
        </Link>
      </div>
      ...
      <Link href="/raffle">
            <button className="text-3xl w-full font-bold bg-black h-[15rem]">Raffle</button>
        </Link>
      </div>
      ...
      <div className="w-[25rem] relative group">
        ...
        <Link href="/marketplace">
            <button className="text-3xl w-full font-bold bg-black h-[15rem]">Marketplace</button>
        </Link>      </div>

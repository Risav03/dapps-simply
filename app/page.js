...
export default function Home() {
  return (
    <main className="text-white text-center px-20 py-36">
      ...
      <h1 className="text-7xl">SIMPLY <span className="bg-gradient-to-b from-green-400 to-green-700 text-transparent bg-clip-text">dApps</span></h1>
    ...
    <div className="w-full items-center justify-center flex flex-row flex-wrap gap-10 mt-24">
      ...
      <div className="w-[25rem] relative  group">
        ...
        <Link href="/burner">
            <button className="text-3xl w-full bg-black h-[15rem]">Burner</button>
        </Link>
      </div>
      ...
      <div className="absolute w-full h-full bg-gradient-to-b from-blue-400 top-0 group-hover:shadow-2xl group-hover:shadow-blue-500/50 to-blue-600 duration-200 z-[-1] group-hover:top-2 "></div>
        <button className="text-3xl w-full bg-black h-[15rem]">Raffle</button>
      </div>
      ...
      <div className="w-[25rem] relative group">
        ...
        <button className="text-3xl w-full bg-black h-[15rem]">Marketplace</button>
      </div>

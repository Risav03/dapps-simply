...
export default function Navbar(){
    ...
    return(
        <div className="flex sm:flex-row flex-col sm:items-end sm:justify-end mb-5 items-center justify-center">
            <div className="my-auto sm:mb-0 mb-5 mr-10 bg-blue-400 py-2 px-4 rounded-xl border-blue-600 border-2 font-bold">
                <h2>Balance: {balance} $SIMPLE</h2>
            </div>
            <WalletConnectButton/>
        </div>
    )
